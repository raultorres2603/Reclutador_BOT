...
client.on('message', msg => {
    if (msg.channel.id === '720598748001992777' && msg.content.substring(0,5) == 'busco') {
        msg.reply('Anuncio de busqueda de tripulacion creado en el canal de #buscar-tripulacion');
        //ID del usuario
        user = msg.author.id;
        ...
        msg.reply('Anuncio de busqueda de equipo creado en el canal de #buscar-equipo');
        //ID del usuario
        user = msg.author.id;
        //Enviar mensaje a un canal
        //Poner entre corchetes con @ el ID de usuario y con @& si es un rol
